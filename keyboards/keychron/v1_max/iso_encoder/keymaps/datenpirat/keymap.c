...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_BASE] = LAYOUT_iso_83(
     ...
     TD(TD_CAPS), KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_NUHS,  KC_ENT,             KC_END,
        KC_LSFT,  LT(L_NUBS,KC_NUBS), KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  MT(MOD_RSFT, KC_HOME),  KC_UP,
    ...
    [L_FN] = LAYOUT_iso_83(
        ...
        _______,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  _______,  KC_LEFT,  KC_DOWN,  KC_UP  ,  KC_RGHT,  _______,  _______,  _______,            KC_END,
    ...
    [L_CAPS] = LAYOUT_iso_83(
        ...
        XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_WH_U,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_PGUP,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,                      XXXXXXX,
        _______,  KC_HOME,  KC_WH_L,  KC_WH_D,  KC_WH_R,  KC_HOME,  KC_LEFT,  KC_DOWN  ,KC_UP  ,  KC_RGHT,  KC_END ,  XXXXXXX,  XXXXXXX,  KC_PENT,            XXXXXXX,
        XXXXXXX,  KC_NUBS,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_PGDN,  XXXXXXX,  KC_PDOT,  XXXXXXX,            XXXXXXX,  KC_PGUP,
    ...
    [L_NUBS] = LAYOUT_iso_83(
        ...
        _______,  _______,  KC_MS_LEFT,  KC_MS_DOWN,  KC_MS_RIGHT,  _______,  _______,  KC_MS_BTN1,  KC_MS_BTN2  ,KC_MS_BTN3,  _______,  _______,  _______,  _______,            _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______ , _______,  _______,  _______,  _______
    ),

    [L_RCTL] = LAYOUT_iso_83(
        KC_NUM,  KC_PSCR,  KC_SCRL,  KC_PAUS,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            KC_MPLY,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,                      _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______  ,_______,  _______,  _______,  _______,  _______,            _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
